...
from subsets_utils import get, save_raw_json, load_raw_json, merge, validate, publish
...
METADATA = {
    ...
    "column_descriptions": {
        ...
        "group_description": "Description of the group's contents",
        "series_id": "Unique identifier for the series within the group",
        "series_label": "Human-readable label for the series",
        "series_link": "API link to the series data",
    },
}
